...
import (
	...
	"github.com/Safrochain_Org/safrochain/x/tokenfactory/keeper"
...
func (s *KeeperTestSuite) SetupTest() {
	...
	fundAccsAmount := sdk.NewCoins(sdk.NewCoin("usaf", sdkmath.NewInt(100000000)), sdk.NewCoin("usecond", sdkmath.NewInt(100000000)))
