...
func (q queryServer) FeeShare(
	...
	if err != nil {
		return nil, status.Errorf(
			...
			"invalid format for contract %s, should be bech32 ('safrochain...')", req.ContractAddress,
		)
	}
...
func (q queryServer) DeployerFeeShares( // nolint: dupl
	...
	if err != nil {
		return nil, status.Errorf(
			codes.InvalidArgument,
			"invalid format for deployer %s, should be bech32 ('safrochain...')", req.DeployerAddress,
		)
	}
...
func (q queryServer) WithdrawerFeeShares( // nolint: dupl
	...
	if err != nil {
		return nil, status.Errorf(
			codes.InvalidArgument,
			"invalid format for withdraw addr %s, should be bech32 ('safrochain...')", req.WithdrawerAddress,
		)
	}
