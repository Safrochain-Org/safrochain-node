...
const (
	// Amino names
	registerFeePayContract   = "safrochain/x/feepay/MsgRegisterFeePayContract"
	unregisterFeePayContract = "safrochain/x/feepay/MsgUnregisterFeePayContract"
	fundFeePayContract       = "safrochain/x/feepay/MsgFundFeePayContract"
	updateFeeShareParams     = "safrochain/x/feepay/MsgUpdateParams"
)
