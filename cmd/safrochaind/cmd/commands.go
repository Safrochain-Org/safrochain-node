...
var tempDir = func() string {
	dir, err := os.MkdirTemp("", "safrochain")
	if err != nil {
...
func appExport(
	...
	if height != -1 {
		if err := safrochainApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	}

	return safrochainApp.ExportAppStateAndValidators(forZeroHeight, jailAllowedAddrs, modulesToExport)
}
